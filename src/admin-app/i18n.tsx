...
const translations: Record<LocaleKey, Dictionary> = {
	"pt-BR": {
		...
		"billing.title": "Plano",
		"billing.subtitle":
			"Os planos seguem o mesmo modelo comercial da Shopify: On-demand com cobrança por uso e Pro com mensalidade + excedente por uso.",
		...
		"billing.planIncludes": "Imagens incluídas",
		"billing.pricePerExtra": "Preço por imagem extra",
		...
		"sizeCharts.subtitle":
			"Configure tabelas por categoria e gênero, reaproveitando a estrutura do app Shopify.",
		...
		"analytics.subtitle":
			"Indicadores adaptados do app Shopify, combinando uso, recomendações e impacto operacional.",
	...
	en: {
		...
		"billing.title": "Plan",
		"billing.subtitle":
			"Plans follow the same commercial model as Shopify: On-demand with pay-per-use and Pro with monthly fee plus usage overage.",
	...
	es: {
		...
		"billing.title": "Plan",
		"billing.subtitle":
			"Los planes siguen el mismo modelo comercial de Shopify: On-demand con cobro por uso y Pro con mensualidad + excedente por uso.",
